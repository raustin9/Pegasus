...
//            std::cout << "EVENT REGISTERED FOR " << code << ": " << event_state.registered[code].events.size() << std::endl;
//            return true;
//        }
//
...
//        static bool Fire(uint16_t code, void* sender, EventContext context) {
//            if (event_state.registered[code].events.size() == 0) {
//                std::cout << "Nothing registered for this event " << code << std::endl;
//                return false;
//            }
//            std::cout << "Event firing\n";
//
