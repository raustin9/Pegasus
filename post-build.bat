...
tooling\glslc.exe -fshader-stage=vert assets\shaders\Builtin.ObjectShader.vert.glsl -o assets\shaders\Builtin.ObjectShader.vert.spv
IF %ERRORLEVEL% NEQ 0 (echo Error: %ERRORLEVEL% && exit)

echo "assets\shaders\Builtin.ObjectShader.frag.glsl -> bin\assets\shaders\Builtin.ObjectShader.frag.spv"
tooling\glslc.exe -fshader-stage=frag assets\shaders\Builtin.ObjectShader.frag.glsl -o assets\shaders\Builtin.ObjectShader.frag.spv
IF %ERRORLEVEL% NEQ 0 (echo Error: %ERRORLEVEL% && exit)
